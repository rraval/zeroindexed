...
class ValheimDisk extends pulumi.ComponentResource {
    ...
    public constructor(
        ...
        this.persistentVolumeClaim = new k8s.core.v1.PersistentVolumeClaim(name, {
            spec: {
...
export class ValheimServer extends pulumi.ComponentResource {
    ...
    public constructor(
        ...
        this.service = new k8s.core.v1.Service("valheim", {
            metadata: {
                labels,
                annotations: {
        ...
        this.secret = new k8s.core.v1.Secret("valheim", {
            metadata: {labels},
        ...
        this.statefulSet = new k8s.apps.v1.StatefulSet("valheim", {
            metadata: {
                labels,
            },
            spec: {
                ...
                template: {
                    ...
                    spec: {
                        containers: [{
                            ...
                            volumeMounts: persistence.map(({name, mountPath}) => {
                        ...
                        volumes: persistence.map(({name, disk}) => {
                            return {
                                ...
                                persistentVolumeClaim: {
                                    claimName: disk.persistentVolumeClaim.metadata.name,
                                },
                            };
                        }),
                    },
